...
// Use the radius and origins of two circular bounds to determine if 
...
// Draws the remaining lives on screen.
//
...
class Ship {
  ...
  Update() {
    ...
    // If you want to find the new point x use the formulas:
    // newX = oldX + cos(radians) * distance
    // newY = oldY + sin(radians) * distance
